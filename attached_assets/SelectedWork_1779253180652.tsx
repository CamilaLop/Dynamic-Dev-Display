...
export function SelectedWork() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      /*
        Timeline dos cards. Ela NÃO cria ScrollTrigger sozinha.
        A progressão dela é controlada por uma timeline master única.
        Isso torna o movimento reversível sem piscadas.
      */
      ...
      /*
        Master única e reversível.
        Ela controla cards, textos laterais, círculo e label.
        Sem onComplete, sem once, sem criação tardia de ScrollTrigger.
      */
